    ...
    data: {
      ...
      datasets: [
        { label: 'All LW',         data: h.lw,
          borderColor: '#444444', borderWidth: 2, pointRadius: 0,
          tension: 0.15, fill: false },
        { label: 'Base bed-joint', data: h.base,
          borderColor: '#2166AC', borderWidth: 2, borderDash: [6, 3],
          pointRadius: 0, tension: 0.15, fill: false },
        { label: 'In-band',        data: h.inband,
          borderColor: '#D6604D', borderWidth: 2, borderDash: [3, 3],
          pointRadius: 0, tension: 0.15, fill: false },
        { label: `DS3 threshold (${THR_INBAND_DS3})`, data: thrDs3,
          borderColor: '#D6604D', borderWidth: 1, borderDash: [2, 2],
          pointRadius: 0, fill: false },
        { label: `DS2/DS4 threshold (${THR_INBAND_DS4})`, data: thrDs4,
          borderColor: '#D6604D', borderWidth: 1, borderDash: [4, 4],
          pointRadius: 0, fill: false },
      ],
    },
    options: {
