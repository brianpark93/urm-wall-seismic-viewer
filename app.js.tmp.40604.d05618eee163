    ...
    data: {
      ...
      datasets: [
        { label: 'All LW',         data: h.lw,
          borderColor: '#333', borderWidth: 1.8, pointRadius: 0,
          tension: 0.15, fill: false },
        { label: 'Base bed-joint', data: h.base,
          borderColor: '#E07C00', borderWidth: 1.5, borderDash: [6,3],
          pointRadius: 0, tension: 0.15, fill: false },
        { label: 'In-band',        data: h.inband,
          borderColor: '#C0392B', borderWidth: 1.5, borderDash: [3,3],
          pointRadius: 0, tension: 0.15, fill: false },
        { label: `Threshold (${THR_LINE})`, data: thrData,
          borderColor: '#aaa', borderWidth: 0.9, borderDash: [2,4],
